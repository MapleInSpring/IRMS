...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor = self.mainColor;
    self.shopName = [NSArray arrayWithObjects:@"magic show", @"big show", @"water show", @"circus show", @"fire show", @"dance show", @"skating show", nil];
...
//        cell.numLeft.textColor = cell.roomType.textColor;
        ...
        NSString *imageName = [NSString stringWithFormat:@"%@.jpeg", [self.shopName objectAtIndex:indexPath.row]];
